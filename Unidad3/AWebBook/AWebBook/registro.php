...
require './includes/data.php';
    ...
    $administrador = isset($_POST["administrador"]) ? $_POST["administrador"] : false;
    $esAdministrador=0;
    ...
    if (count($errores) == 0) {
        ...
        $check_registro = guardarNuevoUsuario($nombre, $email, $hahed,$esAdministrador, $conn); 
        if ($check_registro){
                ...
                <div class="card p-4 shadow-sm">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="administrador">Eres administrador</label><br>
                        </div>
