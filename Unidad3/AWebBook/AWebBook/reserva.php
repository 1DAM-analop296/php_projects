...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmarReserva'])) {
    ...
    $id_usuario = $_SESSION['id_usuario'];
        ...
        $check_insertar = getInsertarReserva($conn, (int)$id_usuario, (int)$id_libro, $fecha_reserva);
    ...
    <form id="editTarea" method="post" action="" class="p-3 border rounded shadow bg-white">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="titulo" name="titulo"
                 value="<?= $informacion_libro[0]['titulo']; ?>" placeholder="Escribe el título de la tarea" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="autor" name="autor"
                value="<?= $informacion_libro[0]['autor']; ?>" placeholder="Escribe el nombre del autor" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="categoria" name="categoria"
                value="<?= $informacion_libro[0]['nombre']; ?>" placeholder="Escribe el nombre de la categoría" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="stock" name="stock"
               value="<?= $informacion_libro[0]['disponible']; ?>" placeholder="Escribe el stock del libro" required>
        </div>
